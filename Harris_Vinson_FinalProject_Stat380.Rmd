...
JoinedTable2 <-
  JoinedTable %>%
  mutate(JoinedTable$`1985 Pop` * 1000,
         JoinedTable$`1990 Pop` * 1000,
         JoinedTable$`1995 Pop` * 1000,
         JoinedTable$`2000 Pop` * 1000,
         JoinedTable$`2005 Pop` * 1000,
         JoinedTable$`2010 Pop` * 1000,
         JoinedTable$`2015 Pop` * 1000) %>%
...
JoinedTable3 <- 
  JoinedTable2 %>%
  rename(`1985 Pop` = JoinedTable$`1985 Pop` * 1000)
```
