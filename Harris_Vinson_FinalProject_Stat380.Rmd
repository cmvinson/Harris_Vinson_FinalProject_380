...
<<<<<<< HEAD
This was just us finally removing the six countries that we could not get to work out with both.  This was defintely one of our hardest decisions to make but ultimately due to the size 
=======
```{r}
EmissionsTotalData <-
  GlobalNumbers %>%
...
>>>>>>> 0ed070b0255d4d76a05b3603b3feec634a62e5f1
